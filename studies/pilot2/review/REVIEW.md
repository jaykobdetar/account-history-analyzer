# AHAS 1.0.4: repair evidence and second Reddit pilot
...
| Home community | Method | Scored / planned pairs | AUC | AP |
| --- | --- | --- | --- | --- |
| ApplyingToCollege | retained_prose_n4 | 8 / 8 | 1.0 | 1.0 |
| Cornell | retained_prose_n4 | 4 / 8 | 0.75 | 0.8333333333333333 |
| college | retained_prose_n4 | 8 / 8 | 0.875 | 0.8875 |
...
| --- | --- | --- | --- | --- |
| ApplyingToCollege | retained_prose_n4 | 8 / 8 | 1.0 | 1.0 |
| ApplyingToCollege | function_mask_n4 | 8 / 8 | 0.625 | 0.6083333333333333 |
| ApplyingToCollege | function_word_js | 8 / 8 | 1.0 | 1.0 |
| Cornell | retained_prose_n4 | 4 / 8 | 0.75 | 0.8333333333333333 |
| Cornell | function_mask_n4 | 4 / 8 | 0.75 | 0.8333333333333333 |
| Cornell | function_word_js | 4 / 8 | 0.5 | 0.75 |
| college | retained_prose_n4 | 8 / 8 | 0.875 | 0.8875 |
| college | function_mask_n4 | 8 / 8 | 0.875 | 0.8875 |
| college | function_word_js | 8 / 8 | 0.875 | 0.9166666666666666 |
...
| Construction slot | Preparation | Scope status | Qualified windows | Candidates | Nearest error | Best legal grid error | Matched within 10 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| chrono-ApplyingToCollege-pair1-splice-full | labeled_construction | ok | 16 | 0 | unavailable | 5 | False |
| chrono-ApplyingToCollege-pair2-splice-full | labeled_construction | ok | 11 | 1 | 10 | 5 | True |
| chrono-Cornell-pair1-splice-full | unfilled_slot | unavailable | unavailable | unavailable | unavailable | unavailable | unavailable |
| chrono-Cornell-pair2-splice-full | unfilled_slot | unavailable | unavailable | unavailable | unavailable | unavailable | unavailable |
| chrono-college-pair1-splice-full | labeled_construction | ok | 17 | 1 | 5 | 5 | True |
| chrono-college-pair2-splice-full | labeled_construction | ok | 25 | 1 | 0 | 0 | True |
...
The measurement identity is `bfc989028bf2b47c506d1ba501287d4e362aadc25ca5c731c41e4b27a336e179`. All 1,448 protocol, driver, test and prepared files were frozen before scores. Preparation passed 68 combined study tests plus five checks against the actual chronological archives. Independent checks verified every reported content match and component, source fidelity, grouping and guard accounting. The exact commands, starts/finishes, raw logs and failures are linked in [COMMANDS.md](COMMANDS.md).
